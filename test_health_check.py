...
def test_agent_health_check():
    ...
    agent = Agent(name="TestAgent", role="Test", llm_url="http://localhost:9999/v1")  # Несуществующий
...
def test_consult_with_health_check():
    ...
    result = consilium.consult("What is Python?", use_smart_routing=True, check_health=True)
...
def test_consult_skip_health_check():
    ...
    result = consilium.consult("What is Python?", use_smart_routing=True, check_health=False)  # Пропускаем health check
