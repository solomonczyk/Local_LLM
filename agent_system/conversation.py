        ...
        try:
            ...
            if summary["success"]:
                ...
                context = ConversationContext(
                    ...
                    active_files=json.loads(session_data.get("active_files", "[]")) if session_data.get("active_files") else [],
                    project_context=json.loads(session_data.get("project_metadata", "{}")) if session_data.get("project_metadata") else {},
