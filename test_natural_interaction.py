...
def test_proactive_suggestions():
    ...
    response = requests.post(
        ...
        json={
            "model": "enhanced-model",
            "messages": [
                {"role": "user", "content": "Хочу создать новый проект, но не знаю с чего начать"}
            ]
        }
    )
...
def test_file_operations_with_context():
    ...
    response = requests.post(
        ...
        json={
            "model": "enhanced-model",
            "messages": [
                {"role": "user", "content": "покажи список файлов в текущей папке"}
            ]
        }
    )
...
def test_system_info_integration():
    ...
    response = requests.post(
        ...
        json={
            "model": "enhanced-model",
            "messages": [
                {"role": "user", "content": "сколько памяти на моем компьютере?"}
            ]
        }
    )
