...
│   Container     │   Порты: 7865, 8002, 8003
└─────────────────┘
         │
         ▼
┌─────────────────┐
...
### Порты
- **7865** - Web UI (Gradio интерфейс)
- **8002** - LLM API (OpenAI-совместимый)
- **8003** - Tools API (системные инструменты)
...
# Система памяти
curl http://localhost:8003/tools/memory_status
